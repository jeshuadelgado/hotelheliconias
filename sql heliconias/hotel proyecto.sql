...
-- Volcando estructura para tabla hotel.cargo
...
-- Volcando datos para la tabla hotel.cargo: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla hotel.users: ~3 rows (aproximadamente)
...
-- Volcando estructura para tabla hotel.usuario
...
-- Volcando datos para la tabla hotel.usuario: ~0 rows (aproximadamente)
